...
const LINES = {
  ...
  pitMiss: ['Cross-threaded! Again, again!', 'Rear left, rear left! Problem!', 'That is so not right.', 'We are checking the wheel gun.'],
  pitLate: ['Too slow on the gun.', 'Wake up! Wheel gun!', 'The mechanic did it for you. Slowly.'],
