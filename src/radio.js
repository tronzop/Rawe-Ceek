...
const LINES = {
  ...
  scNeutral: ['Race neutralised. Hold station and keep the tyres warm.', 'We have the car. You have the tyres — weave.', 'Weave, weave. Temps are dropping.', 'Keep them in the window. Not too hot.'],
  scJump: ['Great jump! Now push!', 'That is the restart we wanted.', 'Beautiful. Use the tow.'],
  scCold: ['Green flag — but the tyres are cold. Careful.', 'Restart on ice. Nice one.', 'We said weave. Careful, no grip.'],
  scWarm: ['Green flag! Tyres are in the window, push!', 'Perfect temps. Go go go!'],
